...
<body>
    ...
    <section>
        ...
        $query1 = "SELECT * FROM studentsscored WHERE quiz_attempted='Cpp'";
    ...
    {
        ?>
        <div class="notplayed">You haven't played any C++ Quiz</div>
        <div class="notplayed">Click Here to Play a Quiz</div>
        <div class="notplayed"><a href="startCpp.php"><input type="submit" value="Play"></a></div>
        <?php
    }   
    ?>
</body>
