...
<body>
    ...
    <section>
        ...
        $query1 = "SELECT * FROM studentsscored WHERE name='$_SESSION[username]' and quiz_attempted='C-Programming'";
    ...
    {
        ?>
        <div class="notplayed">You haven't played any C-Programming Quiz</div>
        <div class="notplayed">Click Here to Play a Quiz</div>
        <div class="notplayed"><a href="startCquiz.php"><input type="submit" value="Play"></a></div>
        <?php
    }   
    ?>
</body>
