...
<body>
    ...
    <?php
        ...
        $query1 = "SELECT * FROM studentsscored WHERE name='$_SESSION[username]'  and quiz_attempted='Css'";
    ...
    {
        ?>
        <div class="notplayed">You haven't played any CSS Quiz</div>
        <div class="notplayed">Click Here to Play a Quiz</div>
        <div class="notplayed"><a href="startCss.php"><input type="submit" value="Play"></a></div>
        <?php
    }   
    ?>
</body>
