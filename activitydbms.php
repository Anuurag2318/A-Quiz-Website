...
<body>
    ...
    <?php
        ...
        $query1 = "select * from studentsscored WHERE name='$_SESSION[username]' and quiz_attempted='Dbms'";
    ...
    {
        ?>
        <div class="notplayed">You haven't played any DBMS Quizzes</div>
        <div class="notplayed">Click Here to Play a Quiz</div>
        <div class="notplayed"><a href="startDbms.php"><input type="submit" value="Play"></a></div>
        <?php
    }   
    ?>
</body>
