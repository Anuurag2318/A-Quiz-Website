...
<body>
    ...
    <section>
        ...
        $query1 = "select * from studentsscored where name='$_SESSION[username]' and quiz_attempted='Html'";
    ...
    {
        ?>
        <div class="notplayed">You haven't played any HTML Quizzes</div>
        <div class="notplayed">Click Here to Play a Quiz</div>
        <div class="notplayed"><a href="startHtml.php"><input type="submit" value="Play"></a></div>
        <?php
    }   
    ?>
</body>
