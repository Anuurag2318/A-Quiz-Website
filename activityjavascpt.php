...
<body>
    ...
    <section>
        ...
        $query1 = "SELECT * FROM studentsscored WHERE name='$_SESSION[username]' and quiz_attempted='JavaScript'";
    ...
    {
        ?>
        <div class="notplayed">You haven't played any JavaScript Quiz</div>
        <div class="notplayed">Click Here to Play a Quiz</div>
        <div class="notplayed"><a href="startJavaScriptquiz.php"><input type="submit" value="Play"></a></div>
        <?php
    }   
    ?>
</body>
