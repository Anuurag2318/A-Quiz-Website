...
<body>
    ...
    <section>
        ...
        $query1 = "SELECT * FROM studentsscored WHERE name='$_SESSION[username]' and quiz_attempted='Php'";
    ...
    {
        ?>
        <div class="notplayed">You haven't played any PHP Quiz</div>
        <div class="notplayed">Click Here to Play a Quiz</div>
        <div class="notplayed"><a href="startPhp.php"><input type="submit" value="Play"></a></div>
        <?php
    }   
    ?> 
</body>
