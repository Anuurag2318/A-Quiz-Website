...
$number=$_GET['n'];
$ques_number="SELECT * FROM cprogquestions WHERE qid=$number";
$result=mysqli_query($conquiz,$ques_number);
$question=mysqli_fetch_assoc($result);
$ans_options="SELECT * FROM cproganswers WHERE ans_options=$number";
...
<body>
    <div class="main-div">
        <div class="inner-div">
            <form action="markscprog.php" method="post">
            <header>
        ...
        <input type="hidden" name="quiz_attempted" value="C-Programming">
