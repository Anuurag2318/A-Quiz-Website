...
$number=$_GET['n'];
$ques_number="SELECT * FROM dbmsquestions WHERE qid=$number";
$result=mysqli_query($conquiz,$ques_number);
$question=mysqli_fetch_assoc($result);
$ans_options="SELECT * FROM dbmsanswers WHERE ans_options=$number";
...
<body>
    <div class="main-div">
        <div class="inner-div">
            <form action="marksdbms.php" method="post" id="form">
            <header>
            ...
            <?php }?>
        <input type="hidden" name="quiz_attempted" value="Dbms">
