...
$selectquery = "select * from studentsscored where name='$_SESSION[username]' AND quiz_attempted='Html'";
...
<body>
    <div class="main_div">
        <div class="inner-div">
            ...
            <h3>Bravo! <span class="showname_quiz"><?php echo $_SESSION['username']; ?></span>, You have completed the <span class="showname_quiz">HTML</span> quiz successfully with a score of</h3>
            <div id="ShowScore" class="ScoreArea">
                <?php
                $scorehtml = $_SESSION['scorehtml'];
            ...
            <div class="showquestion">
                ...
                for ($i = 1; $i <= 10; $i++) {
                    ...
                    $ans_options = "SELECT * FROM htmlanswers WHERE ans_options=$i AND is_correct=1";
