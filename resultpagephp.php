...
$selectquery = "select * from studentsscored where name='$_SESSION[username]' AND quiz_attempted='Php'";
...
<body>
    <div class="main_div">
        <div class="inner-div">
            ...
            <h3>Bravo! <span class="showname_quiz"><?php echo $_SESSION['username']; ?></span>, You have completed the <span class="showname_quiz">PHP</span> quiz successfully with a score of</h3>
            <div id="ShowScore" class="ScoreArea">
                <?php
                $scorephp = $_SESSION['scorephp'];;
                $_SESSION['scorephp'] = 0; 
                echo $scorephp;
                $scorephp = 0;
            ...
            <div class="showquestion">
                <?php
                for ($i = 1; $i <= 10; $i++) {
                    $q = "SELECT * FROM phpquestions where qid=$i";
                    $query = mysqli_query($con, $q);
                    $ans_options = "SELECT * FROM phpanswers WHERE ans_options=$i AND is_correct=1";
