...
<body>
    <div class="main_div">
        <div class="inner-div">
            ...
            <h3>Bravo! <span class="showname_quiz"><?php echo $_SESSION['username']; ?></span>,You have completed the <span class="showname_quiz">Python</span> quiz successfully with a score of</h3>
            <div id="ShowScore" class="ScoreArea">
                <?php
                $scorepyth = $_SESSION['scorepyth'];
                $_SESSION['scorepyth'] = 0;
                echo $scorepyth;
                $scorepyth = 0;
                // echo $_SESSION['scorepyth'];
            ...
            <div class="showquestion">
                <?php
                for ($i = 1; $i <= 10; $i++) {
                    $q = "SELECT * FROM pythonquestions where qid=$i";
                    $query = mysqli_query($con, $q);
                    $ans_options = "SELECT * FROM pythonanswers WHERE ans_options=$i AND is_correct=1";
